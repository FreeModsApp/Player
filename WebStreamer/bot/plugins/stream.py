...
async def private_receive_handler(c: Client, m: Message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="""<b>This Is a Private Bot For our Streaam.net Users, You have to Join Our Telegram Channel To Verify You</b>""",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍʏ ʙᴏss** @SID12O",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
    try:
